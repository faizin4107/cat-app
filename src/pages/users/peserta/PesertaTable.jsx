            ...
            return (
                <div className="flex space-x-3 rtl:space-x-reverse">
                    <Tooltip content="Edit" placement="top" arrow animation="shift-away">
                        <Link className="action-btn" to={`/edit-peserta/${row?.cell?.row.original.id}`} state={row?.cell?.row.original}><Icon icon="heroicons:pencil-square" /></Link>
              ...
              <Icon icon="heroicons:pencil-square" />
                    ...
                    >
                        ...
                        <button className="action-btn" type="button" onClick={() => handleDelete(row?.cell?.row.original.id, 'peserta')}>
...
const PesertaTable = ({ title = "User Peserta" }) => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            // You can await here
            const response = await getData('/peserta');
        ...
        <>
            <Card>
                <div className="md:flex justify-between items-center mb-6">
                    ...
                    <Button text="Tambah" className="btn-primary btn-sm" icon="uiw:plus-square-o" link="/create-peserta" />
                </div>
                {isLoading ? (
                    <Loading />
                ) : (
