            ...
            return (
                <div className="flex space-x-3 rtl:space-x-reverse">
                    <Tooltip content="Edit" placement="top" arrow animation="shift-away">
                        <Link className="action-btn" to={`/edit-admin/${row?.cell?.row.original.id}`} state={row?.cell?.row.original}><Icon icon="heroicons:pencil-square" /></Link>
              ...
              <Icon icon="heroicons:pencil-square" />
                    ...
                    >
                        ...
                        <button className="action-btn" type="button" onClick={() => handleDelete(row?.cell?.row.original.id, 'admin')}>
...
const AdminTable = ({ title = "User Admin" }) => {
        ...
        <>
            <Card>
                <div className="md:flex justify-between items-center mb-6">
                    ...
                    <Button text="Tambah" className="btn-primary btn-sm" icon="uiw:plus-square-o" link="/create-admin" />
                </div>
                {isLoading ? (
                    <Loading />
                ) : (
