            ...
            return (
                <div className="flex space-x-3 rtl:space-x-reverse">
                    <Tooltip content="Edit" placement="top" arrow animation="shift-away">
                        <Link className="action-btn" to={`/edit-tes-pengetahuan/${row?.cell?.row.original.id}`} state={row?.cell?.row.original}><Icon icon="heroicons:pencil-square" /></Link>
                    </Tooltip>
                    <Tooltip
                        content="Delete"
                        placement="top"
                    ...
                    >
                        ...
                        <button className="action-btn" type="button" onClick={() => handleDelete(row?.cell?.row.original.id, 'tes-pengetahuan')}>
...
const TestPengetahuanTable = ({ title = "Soal Tes Pengetahuan Dasar" }) => {
    ...
    useEffect(() => {
        async function fetchData() {
            const response = await getData('/tes-pengetahuan');
        ...
        <>
            <Card>
                <div className="md:flex justify-between items-center mb-6">
                    ...
                    <Button text="Create Tes Pengetahuan" className="btn-primary btn-sm" icon="heroicons-outline:newspaper" link="/create-tes-pengetahuan" />
                </div>
...
export default TestPengetahuanTable;
