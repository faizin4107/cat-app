...
const CreateTesPengetahuan = () => {
    ...
    const onSubmit = async (data) => {
        ...
        console.log('val sesi', resultStringSesi)
        ...
        try {
            const response = await createData({path: '/tes-pengetahuan', post: formData});
    ...
    return (
        <>
            <Breadcrumbschild menu={{ currentMenu: 'Tes Pengetahuan Dasar', path: `/cat/${params.id}`, state: propsData, childMenu: 'Create Tes Pengetahuan Dasar' }} />
            <div className="grid xl:grid-cols-2 grid-cols-1 gap-5">
                <Card>
                    <div className="md:flex justify-between items-center mb-6">
                        <h4 className="card-title">Create Tes Pengetahuan Dasar</h4>
                    </div>
...
export default CreateTesPengetahuan;
