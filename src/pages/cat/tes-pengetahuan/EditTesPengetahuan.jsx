...
const EditTesPengetahuan = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log('value_sesi', resultStringSesi);
        if(listJawaban.length === 0){
            // console.log('yes')
            if(pilihanJawaban.length === 0){
                // console.log('yes 1')
        ...
        // }
        try {
            const response = await axios.post(`${baseurl.apiUrl}/tes-pengetahuan/${state.id}?_method=PUT`, formData, {
                headers: {
    ...
    return (
        <>
            <Breadcrumbschild menu={{ currentMenu: 'Tes Pengetahuan', path: '/tes-pengetahuan', childMenu: 'Edit Tes Pengetahuan' }} />
            <div className="grid xl:grid-cols-2 grid-cols-1 gap-5">
                <Card>
                    <div className="md:flex justify-between items-center mb-6">
                        <h4 className="card-title">Edit Tes Pengetahuan</h4>
                    </div>
...
export default EditTesPengetahuan;
